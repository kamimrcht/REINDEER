...
# query with Reindeer
./Reindeer --query --count -k 21 -q sample_1000_transcripts.fa -l out_reindeer_2585_counts -t 20 -o results_query_1000_on_2585 #out_reindeer_2585_counts is the directory where Reindeer's index was written
