...
DEBUG ?= 0
ifeq ($(DEBUG), 1)
	CFLAGS+=-O0 -DDEBUGi -fstrict-aliasing -msse4 -lstdc++fs
	...
	CFLAGS+=-DNDEBUG -Ofast -msse4 -fstrict-aliasing  -g -lstdc++fs
	CFLAGS2+=-DNDEBUG -Ofast -msse4 -fstrict-aliasing -g -lstdc++fs
	#WARNS=-Wfatal-errors
endif
