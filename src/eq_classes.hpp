...
void get_eq_classes(string& output, robin_hood::unordered_map<string, pair<count_vector, vector<uint64_t>>>& bucket_class, vector<long>& final_positions, long& prev_pos, ofstream* out);

void get_eq_classes_disk_query(string& output, robin_hood::unordered_map<string, pair<count_vector, vector<uint64_t>>>& bucket_class, vector<long>& final_positions, long& prev_pos, ofstream* out);
